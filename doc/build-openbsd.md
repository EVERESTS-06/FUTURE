...
This guide describes how to build futured, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/future/depends/*-unknown-openbsd*
```
...
(see issue [#6658](https://github.com/future/future/issues/6658)).
