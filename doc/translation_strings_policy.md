...
This document provides guidelines for internationalization of the future Core software.
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `future_en.ts` remains unchanged.
