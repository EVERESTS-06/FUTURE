...
Assumeutxo is a feature that allows fast bootstrapping of a validating futured
instance.
...
```
$ future-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ future-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
