future Core version 0.10.4 is now available from:

  <https://future.org/bin/future-core-0.10.4/>
...
- #6953 `43c2789` Split future-tx into its own package
- #6953 `dfe0d4d` Include future-tx binary on Debian/Ubuntu
