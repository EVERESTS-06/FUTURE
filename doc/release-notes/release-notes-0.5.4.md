future version 0.5.4 is now available for download at:
http://sourceforge.net/projects/future/files/future/future-0.5.4/
...
http://gitorious.org/future/futured-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix future-Qt notifications under Growl 1.3.
Increase required age of future-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxfuture properly when installing future-Qt over it. (Windows)
