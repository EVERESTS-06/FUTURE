future Core version *0.15.2* is now available from:

  <https://futurecore.org/bin/future-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in future-tx (TheBlueMatt)
