future-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/future/files/future/future-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the future
...
New/changed settings (command-line or future.conf file)
--------------------------------------------------------
