future Core version 0.13.2 is now available from:

  <https://future.org/bin/future-core-0.13.2/>
...
- #8908 `4a974b2` Update future-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow future-tx to create v2 transactions (btcdrak)
