future Core version 0.16.3 is now available from:

  <https://futurecore.org/bin/future-core-0.16.3/>
...
been discovered in future Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` futureconsensus: invalid flags error should be set to `futureconsensus_err` (afk11)
