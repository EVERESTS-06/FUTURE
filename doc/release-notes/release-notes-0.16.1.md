future Core version 0.16.1 is now available from:

  <https://futurecore.org/bin/future-core-0.16.1/>
...
- #12843 `df38b13` Test starting futured with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure futured processes are cleaned up when tests end (sdaftuar)
