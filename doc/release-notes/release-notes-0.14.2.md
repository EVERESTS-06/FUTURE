future Core version 0.14.2 is now available from:

  <https://future.org/bin/future-core-0.14.2/>
...
(in future Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate future-config.h as necessary (theuni)
