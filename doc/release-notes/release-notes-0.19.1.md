...
future Core version 0.19.1 is now available from:

  <https://futurecore.org/bin/future-core-0.19.1/>
...
From future Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as future Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, future Core does not yet change appearance when
...
- #17488 fix "futured already running" warnings on macOS (fanquake)
