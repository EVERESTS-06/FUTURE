future Core version 27.0 is now available from:

  <https://futurecore.org/bin/future-core-27.0/>
...
- libfutureconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libfuturekernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build future Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of future Core would
