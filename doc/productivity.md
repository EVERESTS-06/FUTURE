...
```sh
cmake --build build --target futured future-cli
cmake --build build --target future-qt
cmake --build build --target bench_future
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:future/future.git
```
