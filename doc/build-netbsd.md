...
This guide describes how to build futured, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run futured or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/future/future/blob/master/doc/descriptors.md).
...
There are many ways to configure future Core. Here is an example that
