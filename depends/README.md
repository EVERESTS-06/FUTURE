...
**When configuring future Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring future Core:
...
variables will be set when generating the future Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
