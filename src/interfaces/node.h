...
#ifndef future_INTERFACES_NODE_H
#define future_INTERFACES_NODE_H
...
//! Top-level interface for a future node (futured process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or future.conf.
...
#endif // future_INTERFACES_NODE_H
