...
#ifndef future_INTERFACES_INIT_H
#define future_INTERFACES_INIT_H
...
//! (future-gui, future-node, future-wallet, futured, future-qt) and each
...
#endif // future_INTERFACES_INIT_H
