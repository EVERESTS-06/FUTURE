...
#ifndef future_NODE_CONNECTION_TYPES_H
#define future_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/future-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on future’s Peer-to-Peer Network")
...
#endif // future_NODE_CONNECTION_TYPES_H
