...
#ifndef future_COMMON_ARGS_H
#define future_COMMON_ARGS_H
...
extern const char * const future_CONF_FILENAME;
extern const char * const future_SETTINGS_FILENAME;
