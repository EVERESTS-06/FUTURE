...
#ifndef future_COMMON_SIGNMESSAGE_H
#define future_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's future address, it must refer to a public key.
...
#endif // future_COMMON_SIGNMESSAGE_H
