...
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for future Core
#include <util/string.h> // Added for future Core
...
// Added for future Core. Wrapper for checking format strings at compile time.
