...
{
    BOOST_CHECK(TestSplitHost("www.futurecore.org", "www.futurecore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.futurecore.org]", "www.futurecore.org", 0));
    BOOST_CHECK(TestSplitHost("www.futurecore.org:80", "www.futurecore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.futurecore.org]:80", "www.futurecore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.futurecore.org:65536", "www.futurecore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.futurecore.org:0", "www.futurecore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.futurecore.org:", "www.futurecore.org:", 0, false));
}
