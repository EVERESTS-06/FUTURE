// Copyright (c) 2019-2020 The future Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef future_TEST_UTIL_TRANSACTION_UTILS_H
#define future_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // future_TEST_UTIL_TRANSACTION_UTILS_H
