...
#ifndef future_TEST_SCRIPTNUM10_H
#define future_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from future Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // future_TEST_SCRIPTNUM10_H
