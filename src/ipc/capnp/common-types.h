...
#ifndef future_IPC_CAPNP_COMMON_TYPES_H
#define future_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between future processes.
...
//! Functions to serialize / deserialize common future types.
namespace mp {
...
#endif // future_IPC_CAPNP_COMMON_TYPES_H
