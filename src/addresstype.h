...
#ifndef future_ADDRESSTYPE_H
#define future_ADDRESSTYPE_H
 ...
 *  A CTxDestination is the internal data type encoded in a future address
 */
...
/**
 * Generate a future scriptPubKey for the given CTxDestination. Returns a P2PKH
 * script for a CKeyID destination, a P2SH script for a CScriptID, and an empty
 * script for CNoDestination.
 */
CScript GetScriptForDestination(const CTxDestination& dest);

#endif // future_ADDRESSTYPE_H
