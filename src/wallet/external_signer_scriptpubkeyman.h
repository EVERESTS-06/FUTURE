...
#ifndef future_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define future_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // future_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
