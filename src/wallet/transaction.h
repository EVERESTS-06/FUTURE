...
#ifndef future_WALLET_TRANSACTION_H
#define future_WALLET_TRANSACTION_H
...
public:
     ...
     * on this future node, and set to 0 for transactions that were created
...
#endif // future_WALLET_TRANSACTION_H
