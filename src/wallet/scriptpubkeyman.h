...
#ifndef future_WALLET_SCRIPTPUBKEYMAN_H
#define future_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The future Core wallet was originally a collection of unrelated private
...
#endif // future_WALLET_SCRIPTPUBKEYMAN_H
