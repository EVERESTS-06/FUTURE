...
#ifndef future_WALLET_WALLETUTIL_H
#define future_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! future from opening the wallet, thinking it was newly created, and
...
#endif // future_WALLET_WALLETUTIL_H
