...
#ifndef future_QT_WALLETVIEW_H
#define future_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a future wallet, and offers access to
