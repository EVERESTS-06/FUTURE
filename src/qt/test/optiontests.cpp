...
{
    // Test regression https://github.com/future/future/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/future-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/future-core/gui/pull/568.
    // With fListen=false in ~/.config/future/future-Qt.conf and all else left as default,
    // future-qt should set both -listen and -listenonion to false and start successfully.
