...
//! Entry point for futureApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &futureApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for futureGUI tests.
void AppTests::guiTests(futureGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &futureGUI::consoleShown, this, &AppTests::consoleTests);
