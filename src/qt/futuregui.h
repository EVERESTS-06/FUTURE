...
#ifndef future_QT_futureGUI_H
#define future_QT_futureGUI_H
...
/**
  future GUI main class. This class represents the main window of the future UI. It communicates with both the client and
...
public:
    ...
    explicit futureGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~futureGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a future wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, futureUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed future Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(futureUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // future_QT_futureGUI_H
