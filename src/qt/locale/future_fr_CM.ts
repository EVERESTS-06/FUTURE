...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Il s'agit de vos adresses future pour la réception des paiements. Utilisez le bouton "Créer une nouvelle adresse de réception" dans l'onglet "Recevoir" pour créer de nouvelles adresses.
...
<context>
    ...
    <message>
        <source>An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the 