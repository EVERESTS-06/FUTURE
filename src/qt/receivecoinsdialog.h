...
#ifndef future_QT_RECEIVECOINSDIALOG_H
#define future_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of futures */
...
#endif // future_QT_RECEIVECOINSDIALOG_H
