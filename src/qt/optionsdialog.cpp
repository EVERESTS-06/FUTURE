      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->futureAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->futureAtStartup);
    ...
    ui->futureAtStartup->setToolTip(ui->futureAtStartup->toolTip().arg(CLIENT_NAME));
    ui->futureAtStartup->setText(ui->futureAtStartup->text().arg(CLIENT_NAME));

    ui->openfutureConfButton->setToolTip(ui->openfutureConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new futureUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->futureAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openfutureConfButton_clicked()
{
