...
#ifndef future_QT_OPTIONSMODEL_H
#define future_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for future client.
...
public:
    ...
    futureUnit getDisplayUnit() const { return m_display_future_unit; }
...
private:
    ...
    QString language;
    futureUnit m_display_future_unit;
...
Q_SIGNALS:
    void displayUnitChanged(futureUnit unit);
...
#endif // future_QT_OPTIONSMODEL_H
