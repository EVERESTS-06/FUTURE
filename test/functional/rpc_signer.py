...
Verify that a futured node can use an external signer command.
...
class RPCSignerTest(futureTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart futured with -signer=<cmd>',
