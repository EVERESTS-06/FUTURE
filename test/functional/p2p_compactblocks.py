...
# TestP2PConn: A peer we use to send messages to futured, and store responses.
...
class CompactBlocksTest(futureTestFramework):
    ...
    # This test actually causes futured to (reasonably!) disconnect us, so do this last.
    ...
    # Test that futured requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for futured to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # futured will not send blocktxn responses for blocks whose height is
