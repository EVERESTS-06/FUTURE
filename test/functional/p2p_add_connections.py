#!/usr/bin/env python3
# Copyright (c) 2020-present The future Core developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The futured node closes feeler connections as soon as a version
...
class P2PAddConnections(futureTestFramework):
    ...
    def run_test(self):
        ...
        # futured behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that futured sends its own version prior to processing
