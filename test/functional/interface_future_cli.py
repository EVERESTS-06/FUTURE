...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"future-cli -h\" for help or \"future-cli listwallets\" to see "
...
class TestfutureCli(futureTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `future-cli getblockchaininfo`")
        ...
        # Prevent future-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and future-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and future-cli getwalletinfo return expected wallet info")
            ...
            # Test future-cli -generate with -rpcwallet in multiwallet mode.
