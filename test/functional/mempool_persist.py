...
By default, futured will dump mempool on shutdown and
...
class MempoolPersistTest(futureTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent futured from writing mempool.dat to disk. Verify that `savemempool` fails")
