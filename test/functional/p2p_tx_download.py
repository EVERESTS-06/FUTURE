#!/usr/bin/env python3
# Copyright (c) 2019-2021 The future Core developers
...
class TxDownloadTest(futureTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new futured instances, as setting mocktimes has long-term effects on when
