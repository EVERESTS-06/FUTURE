...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the futureTestFramework
    pass


class ExampleTest(futureTestFramework):
    # Each functional test is a subclass of the futureTestFramework class.
    ...
    def custom_method(self):
        ...
        futureTestFramework class so other tests can use it."""
