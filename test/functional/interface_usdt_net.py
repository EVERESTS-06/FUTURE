...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/future/future/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(futureTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our futured node")
