...
class TestShell:
    """Wrapper Class for futureTestFramework.

    The TestShell class extends the futureTestFramework
    ...
    class __TestShell(futureTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by futureTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # futureTestFramework instances are supposed to be constructed with the path
