...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/future/future/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(futureTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/future/future/blob/master/doc/tracing.md#tracepoint-validationblock_connected
