...
```sh
DOCKER_BUILDKIT=1 docker build -t future-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/future -it future-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/future-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/future-core/leveldb-subtree.git (branch future-fork)
* for `src/crypto/ctaes`: https://github.com/future-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/future-core/crc32c-subtree.git (branch future-fork)
* for `src/minisketch`: https://github.com/sipa/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/future-core/secp256k1.git
```
