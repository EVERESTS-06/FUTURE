...
(define* (make-future-cross-toolchain target
                                       #:key
...
desirable for building future Core release binaries."
...
;; failure; see https://github.com/future/future/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-future-cross-toolchain target)))
