...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef future_CHAINPARAMSSEEDS_H\n')
    g.write('#define future_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the future network\n')
    ...
    g.write('#endif // future_CHAINPARAMSSEEDS_H\n')
