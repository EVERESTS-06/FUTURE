...
declare -A LIBS
LIBS[cli]="libfuture_cli.a"
LIBS[common]="libfuture_common.a"
LIBS[consensus]="libfuture_consensus.a"
LIBS[crypto]="crypto/libfuture_crypto.a crypto/libfuture_crypto_x86_shani.a crypto/libfuture_crypto_sse41.a crypto/libfuture_crypto_avx2.a"
LIBS[node]="libfuture_node.a"
LIBS[util]="util/libfuture_util.a"
LIBS[wallet]="wallet/libfuture_wallet.a"
...
# https://github.com/future/future/issues/10102
