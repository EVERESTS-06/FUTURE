...
complete --command futured --no-files

# Extract options
function __fish_futured_get_options
...
complete \
    --command futured \
    --arguments "(__fish_futured_get_options --nofiles)"
