...
# Extract options
function __fish_future_tx_get_options
...
# Extract commands
function __fish_future_tx_get_commands
...
complete \
    --command future-tx \
    --condition "not __fish_future_seen_cmd (__fish_future_tx_get_commands --commandsonly)" \
    --arguments "(__fish_future_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command future-tx \
    --arguments "(__fish_future_tx_get_commands)" \
    --no-files
