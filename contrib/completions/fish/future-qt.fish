...
complete --command future-qt --no-files

# Extract options
function __fish_futureqt_get_options
...
complete \
    --command future-qt \
    --arguments "(__fish_futureqt_get_options --nofiles)"
